...
:root {
    ...
    --cor-fundo: #F2F2F2;        /* fundo claro */
    --cor-texto: #363B40;        /* texto principal */
}
...
header {
    ...
    padding: 40px 20px;
    text-align: center;
    border-bottom: 3px solid var(--cor-marrom);
}
...
/* ======= Estilo especial para "Nossa História" ======= */
.titulo-historia {
    font-size: 4rem;
    font-weight: 800;
    color: var(--titulo-color, #363B40); /* fallback */
    margin-bottom: 2rem;
}
...
.card {
    border: none;
    background-color: rgba(118, 166, 148, 0.15); /* verde suave transparente */
    border-radius: 12px;
    padding: 1rem;
...
.text-box {
    padding: 20px 25px;
    background: rgba(189, 131, 108, 0.1); /* marrom suave translúcido */
    border-radius: 15px;
